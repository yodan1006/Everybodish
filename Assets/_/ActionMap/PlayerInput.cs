...
//     version 1.13.0
//     from Assets/_/ActionMap/PlayerInput.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/_/ActionMap/PlayerInput.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""controlSchemes"": []
        ...
        ~@PlayerInput()
        {
            ...
            UnityEngine.Debug.Assert(!m_Lobby.enabled, "This will cause a leak and performance issues, PlayerInput.Lobby.Disable() has not been called.");
        }
        ...
        public struct LobbyActions
        {
            ...
            /// Construct a new instance of the input action map wrapper class.
            /// </summary>
            public LobbyActions(@PlayerInput wrapper) { m_Wrapper = wrapper; }
            /// <summary>
